...
export const Map = (): JSX.Element => {
  ...
  const [mapTransform, setMapTransform] = useState({ scale: 0.3, translateX: 0, translateY: 0 })
    ...
    <div className="w-full h-screen overflow-auto bg-black relative"
      <div
        ...
        style={{
          ...
          transition: isZooming ? 'transform 0.1s ease-out' : 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
          filter: zoomLevel < 0.6 ? `brightness(0.9) contrast(1.1) saturate(1.2)` : 'none', // Space-like effect
        }}
      >
            ...
            <div className="bg-black/80 backdrop-blur-sm rounded-lg p-4 shadow-2xl border border-white/20">
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  Abu Dhabi Interactive Map - Use mouse wheel to zoom | Zoom: {Math.round(zoomLevel * 100)}% | {zoomLevel < 0.5 ? '🛰️ Space View' : zoomLevel < 1 ? '✈️ Aerial View' : '🏙️ City View'}
                </div>
